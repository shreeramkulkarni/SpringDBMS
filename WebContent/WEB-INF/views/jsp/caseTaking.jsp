        ...
        <nav class="navbar navbar-dark flex-shrink-0 align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="#"><i class="fas fa-window-maximize"></i><span>Doctor</span></a></li>
                    <li class="nav-item" role="presentation"></li>
                    <li class="nav-item" role="presentation">	</li>
...
<!-- Remarks -->									
									...
									<div class="col-lg-8" name="hidethis">
...
<!-- Address -->
									...
									<div class="form-group d-inline">
											...
											<a href = "/SpringDBMS/doctor/pat"><button id="next" name = "hidethis" class="btn btn-primary" type="submit">Next</button>
									</div>
							</div>
						</form>
